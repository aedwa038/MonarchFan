...
if( $row['frozen'] == 1)
{
	echo "You cannot delete a post That is already deleted.";
...
$sql = "UPDATE `aedwards`.`posts` SET `post_content` = '".$update  ."',`frozen` = '1',`Edit_id` = '".$id."' WHERE `posts`.`post_id` =". $_POST[post_id];
...
echo '<a href="topic.php?id='.$row['post_topic'] .'">Successfully Deleted Post </a>';
